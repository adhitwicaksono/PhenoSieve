...
The v0.1 skeleton now includes six toy/demo modules:

| Demo | Location |
|---|---|
| Anthocyanin/flavonoid | `examples/toy_anthocyanin/` |
| Carotenoid core | `examples/toy_multimodule/modules/carotenoid_core.tsv` |
| Lignin core | `examples/toy_multimodule/modules/lignin_core.tsv` |
| Cellulose/cell-wall core | `examples/toy_multimodule/modules/cellulose_wall_core.tsv` |
| ABA signaling core | `examples/toy_multimodule/modules/aba_signaling_core.tsv` |
| Nitrogen assimilation core | `examples/toy_multimodule/modules/nitrogen_assimilation_core.tsv` |

The five additional modules can be run with:

```bash
bash examples/toy_multimodule/run_all_modules.sh
```

These are prototype curation examples for testing the software engine. They should be replaced or refined using KEGG, InterProScan, KofamKOALA, Mercator4/MapMan, PlantCyc/PMN, GO, or literature-derived expert curation for real biological analyses.
